  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterGalleryApp.photo.home.createOrEditLabel">Create or edit a Photo</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
            ...
            <AvForm model={isNew ? {} : photoEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput
                  ...
                  value={isNew ? null : convertDateTimeFromServer(props.photoEntity.taken)}
                />
              </AvGroup>
              <AvGroup>
                ...
                <AvInput
                  ...
                  name="uploaded"
                  placeholder={'YYYY-MM-DD HH:mm'}
                  value={isNew ? null : convertDateTimeFromServer(props.photoEntity.uploaded)}
                />
              </AvGroup>
              <AvGroup>
